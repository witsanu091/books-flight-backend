...
const { userSignInSchema } = require("../../../lib/helper/schemas");
const responseMessage = require("../../../lib/build-response/responseMessage.json");
const authService = require("../../services/authentication/signInService");
...
exports.signIn = async (req, res, next) => {
  ...
  try {
    ...
    const {
      ...
      data: body,
      errors,
    } = validateObjectToSchema(bodyDecrypt, userSignInSchema);
    ...
    const result = await authService.signInService(body);
